<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- ================================================================== -->
    <xsl:template
            match="/ORDERS05/IDOC[ (contains(E1EDK01/BSART,'ZRZ')) or (contains(E1EDK01/BSART,'ZP')) or (contains(E1EDK01/BSART,'ZNB')) or (contains(E1EDK01/BSART,'Z4')) or (contains(E1EDK01/BSART,'ZNS'))or (contains(E1EDK01/BSART,'NB')) ]">
            ...
            <Document-ReceivingAdvice>
                ...
                <ReceivingAdvice-Summary>
                    ...
                    <TotalGoodsReceiptAmount>
                        <xsl:value-of
                                select="format-number(sum(exsl:node-set($processed_lines)/Line/Line-Item/QuantityReceived),'0.00')"/>
                    </TotalGoodsReceiptAmount>
    ...
    <xsl:template match="E1EDP01[normalize-space(UEPOS)][normalize-space(E1EDPA1[PARVW='SLS'])]" mode="INSDES">
        ...
        <Line>
            <Line-Item>
                ...
                <ItemDescription>
                    <xsl:value-of
                            select="substring( exsl:node-set($insdes_lines)/Lines/Line[LineNumber=$pos]/ItemDescription, 1,100)"/>
                </ItemDescription>
            ...
            <Line-ShipFrom>
                ...
                <Name>
                    <xsl:value-of
                            select=" substring( concat( E1EDPA1[PARVW='SLS']/NAME1, ', ',E1EDPA1[PARVW='SLS']/NAME2, ' (', E1EDPA1[PARVW='SLS']/STRAS, ')' ), 1,175)"/>
                </Name>
            </Line-ShipFrom>
        </Line>
    </xsl:template>
